      ...
      <section id="about" className="max-w-3xl mx-auto">
        <div className="card p-6">
          ...
          <p className="text-gray-300">
            Media Finance AI builds modern, cloud-first tools for film & HETV
            finance: Budget Builder, Top Sheet Generator, VAT Checker, Payroll,
            Scenario Planning, and Compliance Guardrails. Fully aligned with
            studio manuals and UK/EU/US incentives.
          </p>
        </div>
      </section>
      ...
      <section id="demos" className="max-w-3xl mx-auto">
        <div className="card p-6">
          ...
          <ul className="grid sm:grid-cols-2 gap-3 text-sm">
            <li>
              <a className="button w-full" href="https://vat-checker.flash.mediafinance.ai" target="_blank" rel="noreferrer">
                VAT Checker
              </a>
            </li>
            <li>
              <a className="button w-full" href="https://budget-builder.flash.mediafinance.ai" target="_blank" rel="noreferrer">
                Budget Builder (AI)
              </a>
            </li>
            <li>
              <a className="button w-full" href="https://top-sheet.flash.mediafinance.ai" target="_blank" rel="noreferrer">
                Top Sheet Generator
              </a>
            </li>
            <li>
              <a className="button w-full" href="mailto:hello@mediafinance.ai">
                More on request
              </a>
            </li>
          </ul>
